...
// [
//   new Coins("./imgs/8_coin/coin_1.png", 250, 300),
//   new Coins("./imgs/8_coin/coin_1.png", 300, 330),
//   new Coins("./imgs/8_coin/coin_1.png", 380, 250),
//   new Coins("./imgs/8_coin/coin_1.png", 400, 200),
//   new Coins("./imgs/8_coin/coin_1.png", 580, 300),
//   new Coins("./imgs/8_coin/coin_1.png", 610, 300),
//   new Coins("./imgs/8_coin/coin_1.png", 655, 330),
//   new Coins("./imgs/8_coin/coin_1.png", 700, 200),  
//   new Coins("./imgs/8_coin/coin_1.png", 780, 150),
//   new Coins("./imgs/8_coin/coin_1.png", 800, 200),
//   new Coins("./imgs/8_coin/coin_1.png", 1000, 100),
//   new Coins("./imgs/8_coin/coin_1.png", 1200, 150),
//   new Coins("./imgs/8_coin/coin_1.png", 1280, 400),
//   new Coins("./imgs/8_coin/coin_1.png", 1600, 250),
//   new Coins("./imgs/8_coin/coin_1.png", 1650, 200),
//   new Coins("./imgs/8_coin/coin_1.png", 1700, 150),        
//   new Coins("./imgs/8_coin/coin_1.png", 1750, 150),
//   new Coins("./imgs/8_coin/coin_1.png", 1800, 200),
//   new Coins("./imgs/8_coin/coin_1.png", 1850, 250),
//   new Coins("./imgs/8_coin/coin_1.png", 2600, 100),    
// ]
